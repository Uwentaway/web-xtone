...
const MessageForm: React.FC<MessageFormProps> = ({ onSend }) => {
  ...
  return (
    <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-lg rounded-xl shadow-lg p-6">
      {error && (
        <div className="bg-red-100/90 dark:bg-red-900/30 text-red-800 dark:text-red-200 px-4 py-3 rounded-lg mb-4 backdrop-blur-sm">
          {error}
        </div>
      )}
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white/70 dark:bg-gray-700/70 backdrop-blur-sm focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200"
            />
          </div>
        </div>
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            <textarea
              ...
              rows={5}
              className="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white/70 dark:bg-gray-700/70 backdrop-blur-sm focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200"
            />
        ...
        <button
          ...
          className={`w-full flex items-center justify-center py-3 px-4 rounded-lg text-white font-medium transition-all duration-300 ${
            isLoading 
              ? 'bg-purple-400/90 cursor-not-allowed backdrop-blur-sm' 
